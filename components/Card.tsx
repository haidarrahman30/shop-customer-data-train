...
const Card = ({ title, caption, sourceImage }: CardProps) => {
  return (
    <div className="relative flex flex-col min-w-0 break-words bg-white shadow-xl rounded-2xl bg-clip-border lg:w-1/3 ">
        ...
        <div className="flex flex-wrap -mx-3">
          ...
          <div className="max-w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
            <div className="h-full bg-gradient-to-tl from-blue-500 to-violet-500 rounded-xl">
              <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-tailwind/img/shapes/waves-white.svg" alt="waves" className="absolute top-0 hidden w-1/2 h-full lg:block" />
